...
import styles from '../css Module/HomeNavbar.module.css'
...
export default function HomeNavbar(){
   ...
   <svg
        ...
        >
          <g fill="none">
            ...
            ></path>
            <path
              d="M168.8 16.3h-5.2v-5.2h-1.4v6.6h6.6v-1.4z"
              fill="#00629A"
            ></path>
            <path
   ...
   <Spacer/>
      <Text className={styles.link}>TOOLS</Text>
      <Text className={styles.link}>PRICING</Text>
      <Text className={styles.link}>SOLUTIONS</Text>
      <Text className={styles.link}>PARTNERS</Text>
      <Text className={styles.link}>APPS</Text>
